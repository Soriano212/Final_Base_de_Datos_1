...
GRANT SELECT, INSERT ON soriano_malo_final.responde_abierta TO 'encuestado'@'localhost';
GRANT SELECT, INSERT ON soriano_malo_final.escoge_opcion TO 'encuestado'@'localhost';
GRANT INSERT ON soriano_malo_final.bitacora_respuesta TO 'encuestado'@'localhost';
GRANT EXECUTE ON PROCEDURE soriano_malo_final.usuario_res_encuesta TO 'encuestado'@'localhost';
GRANT EXECUTE ON PROCEDURE soriano_malo_final.puede_crear_encuesta TO 'encuestado'@'localhost';
FLUSH PRIVILEGES;
...
GRANT SELECT, INSERT ON soriano_malo_final.responde_abierta TO 'creador'@'localhost';
GRANT SELECT, INSERT ON soriano_malo_final.escoge_opcion TO 'creador'@'localhost';
...
GRANT EXECUTE ON PROCEDURE soriano_malo_final.usuario_res_encuesta TO 'creador'@'localhost';
GRANT EXECUTE ON PROCEDURE soriano_malo_final.puede_crear_encuesta TO 'creador'@'localhost';
FLUSH PRIVILEGES;
